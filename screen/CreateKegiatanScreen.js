...
const CreateKegiatanScreen = ({navigation}) => {
            ...
            <ScrollView>
                ...
                <View>
                    <MultiSelect
                        ...
                        selectText="Pilih Peserta Kegiatan"
                    ...
                    <HelperText type="error" style={{display: isError1? "flex":"none", marginTop: -10, marginBottom: 10}}>
                        Peserta Kegiatan harus terisi
                    </HelperText>

                </View>
                <View>
                    <TextInput onChangeText={setTopik} label="Topik Kegiatan" mode="outlined"  style={{ marginBottom: 10 }}></TextInput>
                    <HelperText type="error" style={{display: isError2? "flex":"none", marginTop: -10, marginBottom: 10}}>
                        Topik Kegiatan harus terisi
                    </HelperText>
                </View>
                <View>
                    <TextInput onChangeText={setAgenda} label="Agenda Kegiatan" mode="outlined" style={{ marginBottom: 10 }}></TextInput>
                    <HelperText type="error" style={{display: isError3? "flex":"none", marginTop: -10, marginBottom: 10}}>
                        Agenda Kegiatan harus terisi
                    </HelperText>
                </View>
                <View>
...
export default CreateKegiatanScreen